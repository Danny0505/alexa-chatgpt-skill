...
# Clave de OpenAI (reemplaza con tu clave real)
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_text = ("Bienvenido a Chat Skynet. "
                       "Puedes preguntarme cualquier cosa. ¿Qué puedo hacer por ti?")
        return (
            handler_input.response_builder
                .speak(speech_text)
                .ask("¿Qué te gustaría preguntar?")
                .response
        )
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speech_text = ("Puedo ayudarte respondiendo preguntas sobre muchos temas. "
                       "Simplemente pregúntame lo que desees.")
...
class CancelOrStopIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        return handler_input.response_builder.speak("Adiós. Hasta luego.").response
...
class SessionEndedRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # Aquí no es necesario hacer nada específico al finalizar la sesión.
...
# Inicializa el SkillBuilder y registra los handlers.
sb = SkillBuilder()
